...
Install sc.eprocessos with uv.

```shell
uv add sc.eprocessos
```
...
- [Issue tracker](https://github.com/simplesconsultoria/sc-eprocessos/issues)
- [Source code](https://github.com/simplesconsultoria/sc-eprocessos/)
