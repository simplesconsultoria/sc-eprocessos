"""Tests for the Vereadores content type."""
...
from sc.eprocessos.content.vereadores import Vereadores
...
PERMISSION_ADD = "sc.eprocessos: Add Vereadores"
EXPECTED_BEHAVIORS = (
    "plone.basic",
    "plone.namefromtitle",
    "plone.shortname",
...
class TestFTI:
    """Test Factory Type Information registration for Vereadores."""
    ...
    def test_fti_exists(self):
        """Vereadores FTI is registered as a DexterityFTI."""
    ...
    @pytest.mark.parametrize(
        ...
        (
            ...
            ("klass", "sc.eprocessos.content.vereadores.Vereadores"),
            ("add_permission", "sc.eprocessos.AddVereadores"),
...
class TestContentType:
    """Test Vereadores content type creation and class attributes."""

    @pytest.fixture(autouse=True)
    def _setup(self, portal, content_factory):
        self.portal = portal
        self.content = content_factory(portal, PORTAL_TYPE, title="Vereadores")
    ...
    def test_instance_class(self):
        """Content is an instance of Vereadores and EProcessosFacade."""
        assert isinstance(self.content, Vereadores)
        assert isinstance(self.content, EProcessosFacade)

    def test_provides_marker_interface(self):
        """Content provides both IVereadores and IEProcessosFacade."""
        assert IVereadores.providedBy(self.content)
...
class TestPermissions:
    """Test add permission for Vereadores."""
    ...
    def test_roles_with_add_permission(self, role, can_add, roles_with_permission):
        """Only Manager and Site Administrator can add Vereadores."""
