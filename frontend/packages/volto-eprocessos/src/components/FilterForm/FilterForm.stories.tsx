...
import SessoesLista from '../Sessoes/SessoesLista';
...
const meta = {
  title: 'Public/Components/FilterForm',
  component: FilterForm<SessaoSummary>,
  decorators: [withWrapper],
  parameters: { layout: 'centered' },
  tags: ['autodocs'],
} satisfies Meta<typeof FilterForm<SessaoSummary>>;

export default meta;
type Story = StoryObj<typeof meta>;

export const Empty: Story = {
  name: 'Empty (form expanded)',
  args: {
    schema: FORM_CONFIG,
    items: [],
...
export const WithResults: Story = {
  name: 'With results (form collapsed)',
  args: {
    schema: FORM_CONFIG,
    items: ITEMS,
    ResultsComponent: SessoesLista,
