...
# Local Stack
###########################################
.PHONY: stack-eprocessos-build
stack-eprocessos-build:  ## Local Stack: Build e-Processos Mock image
	@echo "Build e-Processos Mock image for the local Docker stack"
	@docker compose -f docker-compose.yml build eprocessos-mock

.PHONY: stack-eprocessos-start
stack-eprocessos-start:  ## Local Stack: Start e-Processos Mock
	@echo "Start e-Processos Mock in the local Docker stack"
	@docker compose -f docker-compose.yml up -d eprocessos-mock

.PHONY: stack-eprocessos-stop
stack-eprocessos-stop:  ## Local Stack: Stop e-Processos Mock
	@echo "Stop e-Processos Mock in the local Docker stack"
	@docker compose -f docker-compose.yml stop eprocessos-mock
